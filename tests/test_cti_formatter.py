...
def test_header_severity_follows_score_not_layer():
    ...
    assert "🔴" in critical and "CRITICAL" in critical
...
def test_single_paragraph_renders_only_summary():
    ...
    assert "Technical Impact" not in msg
